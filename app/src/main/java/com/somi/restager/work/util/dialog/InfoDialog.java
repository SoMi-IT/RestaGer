package com.somi.restager.work.util.dialog;
...
public class InfoDialog extends Dialog implements Button.OnClickListener {
    ...
    public InfoDialog(Activity _context, String info, String site, String floor, String department) {
        ...
        if (info.equals("")) {
            ...
            iv_icon.setImageDrawable(ContextCompat.getDrawable(_context, R.drawable.ic_location_info));
            ...
            iv_icon.setImageDrawable(ContextCompat.getDrawable(_context, R.drawable.ic_info));
